...
<br>
In the case that any of the links above become broken over time I have provided a backup archive in this repository: <a href="https://github.com/AntyScammer/Antypodish/archive/main.zip">web_backup.zip</a>
